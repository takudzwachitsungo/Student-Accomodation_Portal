...
class BookingsList extends StatelessWidget {
  List<Product> products = [
    ...
    Product('assets/jeans_1.png', 'Room Checking', 'Jeans for you', 20,
        Icons.check),
    Product('assets/womanshoe_3.png', 'Cart', 'Shoes with special discount', 30,
        Icons.shopping_cart),
    Product('assets/bag_10.png', 'Payment', 'Bag for your shops', 40,
        Icons.payment),
